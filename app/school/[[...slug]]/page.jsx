...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: "Find the Best Boarding Schools in Seconds | Schools123",
      description: "Find your dream boarding school in seconds with Schools123. Unlock a world of educational possibilities. Your path to the perfect education begins here.",
    ...
    structuredData: [
      {
        ...
        "@type": "WebPage",
        url: `https://www.schools123.com/school/${sheetName}/${categoryData.slug}`,
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "Schools123",
            item: "https://www.schools123.com",
          },
          {
            "@type": "ListItem",
            position: 2,
            name: categoryData.Town,
            item: `https://www.schools123.com/category/boarding-schools-in-${sheetName}`,
          },
          {
            "@type": "ListItem",
            position: 3,
